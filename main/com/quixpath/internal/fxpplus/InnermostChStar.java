...
/*package*/class InnermostChStar extends AbstractTerm implements ITerm {

	private final String A;
	private final ITerm F;

	public InnermostChStar(String a, ITerm f) {
		super();
		A = a;
		F = f;
	}
	...
	public IFXPTerm expand(final IFXPFactory fxpTermFactory) {
		return fxpTermFactory.innerMost(A, F.expand(fxpTermFactory));
	}
